...
import { Text, View, ScrollView, FlatList, Modal, StyleSheet, PanResponder, Alert } from 'react-native';
...
function RenderDish(props) {
    ...
    if (dish != null) {
        return (
            <Animatable.View animation="fadeInDown" duration={2000} ref={this.handleViewRef} delay={1000} {...panResponder.panHandlers}>
                <Card
